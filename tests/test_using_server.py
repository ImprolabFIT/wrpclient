...
async def test_get_cameras_async(wrp_server, repeat, cameras_cnt):
    ...
    for i in range(repeat):
        camera_list_server = WRPServer.generate_random_valid_camera_list(
            cameras_cnt)
        ...
        for client_camera, server_camera in zip(
                camera_list_client, camera_list_server):
